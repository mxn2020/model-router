...
export default function DashboardPage() {
  return (<div style={{padding:"var(--space-8)",maxWidth:1200}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"var(--space-4)",marginBottom:"var(--space-8)"}}>
      ...
      ].map(m=>(<div key={m.l} className="card" style={{padding:"var(--space-5)",borderTop:"3px solid var(--color-accent-primary)"}}>
      ...
      <table style={{width:"100%",borderCollapse:"collapse"}}>
        ...
        <tbody>
          {[
            ...
            <td style={{padding:"12px 0"}}><span className="badge badge-yellow">{r.m}</span></td>
